...
import Wall from 'DemoPages/Wall';
import Login from 'DemoPages/UserPages/Login';
import HashTag from "DemoPages/Wall/Hashtag"
...
const Posts = lazy(() => import('../../DemoPages/Posts'));
    ...
    return (
        <Fragment>
            ...
            <Suspense fallback={
                ...
                <Route path="/posts" component={Wall}/>
            </Suspense>
            <Suspense fallback={
                <div className="loader-container">
                    <div className="loader-container-inner">
                ...
                <Route path="/hashtag/:selectedProject/:tag" component={HashTag}/>
            </Suspense>
